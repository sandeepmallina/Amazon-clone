...
function Register() {
  ...
  return (
    ...
    <form >
      <input className='input_style' type="text" placeholder='Username' value={username}  onChange={e => setUsername(e.target.value)}/>
      <input className='input_style' type="text" placeholder='Email' value={email} onChange={e => setEmail(e.target.value)} />
      <input className='input_style' type="password" placeholder='Password' value={password} onChange={e => setPassword(e.target.value)} />
      <input className='input_style' type="password" placeholder='Confrom Password' value={confrmpassword} onChange={e => setConfrmpassword(e.target.value)}/>
      <label>{error}</label>
